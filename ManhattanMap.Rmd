...
```{r test correct}
#ignore
t <- test_function(month_in = c(1,2,3,4,5,6),week_in = c(0,6), PU = "Washington Heights South", DO = "Morningside Heights",min_distance = 0,max_distance = 100)
test <- test_function(month_in = c(1,2,3,4,5,6),week_in = c(0,6), PU = "Washington Heights South", DO = "Morningside Heights") %>% 
  summary() %>%
  unlist() 
    ...
    fluidRow(
      ...
      column(width = 9,
       ...
       column(width = 3,
        ...
        radioButtons("time", "Deparature Time", time, inline = TRUE),
...
server <- function(input, output, session) {
  ...
  observeEvent(input$button, {
    ...
    time_range <- c(time_start_dictionary[[time_choose]]:(time_end_dictionary[[time_choose]] - 1))
