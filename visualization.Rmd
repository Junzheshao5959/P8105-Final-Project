...
#hp3 =
  ...
  ggplot(aes(season, time_of_day)) +
  geom_tile(aes(fill = grp_mean), color = "white", lwd = 0.8, linetype = 1) +
  scale_fill_gradient(low = "red", high = "white", limits = c(10, 27)) +
